...
jsPsych.plugins["memory-mask-display"] = (function () {

  var plugin = {};

  plugin.info = {
    name: 'memory-mask-display',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    trial.stimulus(c, trial.mask_size, trial.mask_std, 0, trial.spatial_freq, trial.colour1, trial.colour2, trial.bg_col)
    // store response
    var response = {
      rt: null,
      key: null
