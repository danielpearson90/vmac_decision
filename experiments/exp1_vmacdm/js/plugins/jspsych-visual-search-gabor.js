...
jsPsych.plugins["visual-search-gabor"] = (function () {
  var plugin = {};
  ...
  plugin.info = {
    ...
    parameters: {
      search_stimuli: {
        ...
        default: undefined,
        description:
          "Path to image file that is the search_stimuli/distractor.",
      },
      placeholder_stimuli: {
        type: jsPsych.plugins.parameterType.IMAGE,
      ...
      target_horizontal_key: {
        ...
        default: "c",
        description:
          "The key to press if the line in the target is horizontal.",
      },
      target_vertical_key: {
        type: jsPsych.plugins.parameterType.KEYCODE,
      ...
      var after_response = function (info) {
        ...
        if (
          (jsPsych.pluginAPI.compareKeys(
            info.key,
            trial.target_horizontal_key
          ) &&
            trial.target_type == 2) ||
          (jsPsych.pluginAPI.compareKeys(info.key, trial.target_vertical_key) &&
            trial.target_type == 1)
        ) {
          correct = 1;
        }
